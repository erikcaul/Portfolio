...
def buy():
    ...
    if request.method == "POST":
        ...
        db.execute("INSERT INTO transactions (user_id, symbol, shares, price_per_share, stock_name, total_price) VALUES(:user_id, :symbol, :shares, :price, :name, :total_price)",
        user_id=session["user_id"], symbol=request.form.get("symbol"), shares=shares, price=current_price, name=stock_name, total_price=total_price)
...
def sell():
    ...
    if request.method == "POST":
        ...
        stocks = db.execute("SELECT SUM(shares) FROM transactions WHERE user_id = :user_id AND symbol = :symbol GROUP BY symbol",
        ...
        db.execute("UPDATE users SET cash = cash + :price WHERE id = :user_id", price=total_price, user_id=session["user_id"])
        db.execute("INSERT INTO transactions (user_id, symbol, shares, price_per_share, stock_name, total_price) VALUES(:user_id, :symbol, :shares, :price, :name, :total_price)",
        user_id=session["user_id"], symbol=symbol, shares=-shares, price=current_price, name=stock_name, total_price=total_price)
